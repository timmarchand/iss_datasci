...
- [**TidyTuesday**](https://github.com/rfordatascience/tidytuesday): TidyTuesday is a weekly community social data project where people in the data science community take some dataset and do something neat with it. They have an [archive of weekly datasets since 2018](https://github.com/rfordatascience/tidytuesday?tab=readme-ov-file#datasets)

- [**Data is Plural**](https://www.data-is-plural.com/): Jeremy Singer-Vine sends a weekly newsletter of the most interesting public datasets he's found. You should subscribe to it. [He also has an archive of all the datasets he's highlighted.](https://docs.google.com/spreadsheets/d/1wZhPLMCHKJvwOkP4juclhjFgqIY8fQFMemwKL2c64vk/edit#gid=0)
