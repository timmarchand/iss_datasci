...
When choosing colors, you need to make sure you work with a palette that matches the nature of your data. There are three broad categories of color-able data: sequential, diverging, and qualitative.
