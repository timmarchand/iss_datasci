...
Remember that the best destination for your downloaded `.zip` file is your **ISS_DATASCI** folder on your desktop.
...
Then choose where you want to unzip all the files and click on "Extract" (remember that the best destination is your **ISS_DATASCI** folder on your desktop).
