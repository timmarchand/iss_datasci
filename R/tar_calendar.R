...
build_schedule_for_page <- function(schedule_file) {
  schedule <- read_csv(schedule_file, show_col_types = FALSE) |>
    ...
    mutate(var_project = ifelse(!is.na(project),
                                glue('<a href="{project}.qmd"><i class="fa-solid fa-diagram-project fa-lg"></i></a>'),
                                glue('<font color="#e9ecef"><i class="fa-solid fa-diagram-project fa-lg"></i></font>'))) |>
