---
title: "Exercise 12: Text as Data"
date: "2026-07-13"
---
...
::: {.callout-important}
Before starting this exercise, make sure you have worked through [the lesson for this week](/lesson/12-lesson.qmd).
:::
...
1. Download and open the project for this week:
   ...
   - [{{< fa file-archive >}} `12-content.zip`](/files/content/12-content.zip): Download this file, [*unzip it*](/resource/unzipping.qmd), and double-click on `12-content.Rproj` to open it in RStudio.

2. Rename the Quarto file from `12-exercise.qmd` to something that includes your name, e.g. `tanaka-yuki_exercise-12.qmd`, and open it.
