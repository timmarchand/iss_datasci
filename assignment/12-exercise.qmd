...
1. Download and open the project for this week:
   ...
   - [{{< fa file-archive >}} `12-exercise.zip`](/projects/12-exercise.zip): Download this file, [*unzip it*](/resource/unzipping.qmd), and double-click on `12-exercise.Rproj` to open it in RStudio.
