---
title: "Exercise 05: Visualising Probability"
date: "2026-05-25"
---
...
::: {.callout-important}
Before starting this exercise, make sure you have worked through [the lesson for this week](/lesson/05-lesson.qmd).
:::
...
1. Download and open the project for this week:
   ...
   - [{{< fa file-archive >}} `05-content.zip`](/files/content/05-content.zip): Download this file, [*unzip it*](/resource/unzipping.qmd), and double-click on `05-content.Rproj` to open it in RStudio.

2. Rename the Quarto file from `05-exercise.qmd` to something that includes your name, e.g. `tanaka-yuki_exercise-05.qmd`, and open it.
