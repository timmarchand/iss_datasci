...
1. Download and open the project for this week:
   ...
   - [{{< fa file-archive >}} `05-exercise.zip`](/projects/05-exercise.zip): Download this file, [*unzip it*](/resource/unzipping.qmd), and double-click on `05-exercise.Rproj` to open it in RStudio.
