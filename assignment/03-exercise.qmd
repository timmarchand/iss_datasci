...
1. Download and open the project for this week:
   ...
   - [{{< fa file-archive >}} `03-exercise.zip`](/projects/03-exercise.zip): Download this file, [*unzip it*](/resource/unzipping.qmd), and double-click on `03-exercise.Rproj` to open it in RStudio.
