---
title: "Exercise 03: R Basics 2: Data Visualisation"
date: "2026-05-11"
---
...
::: {.callout-important}
Before starting this exercise, make sure you have worked through [the lesson for this week](/lesson/03-lesson.qmd).
:::
...
1. Download and open the project for this week:
   ...
   - [{{< fa file-archive >}} `03-content.zip`](/files/content/03-content.zip): Download this file, [*unzip it*](/resource/unzipping.qmd), and double-click on `03-content.Rproj` to open it in RStudio.

2. Rename the Quarto file from `03-exercise.qmd` to something that includes your name, e.g. `tanaka-yuki_exercise-03.qmd`, and open it.
