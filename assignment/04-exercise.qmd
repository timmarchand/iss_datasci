...
1. Download and open the project for this week:
   ...
   - [{{< fa file-archive >}} `04-exercise.zip`](/projects/04-exercise.zip): Download this file, [*unzip it*](/resource/unzipping.qmd), and double-click on `04-exercise.Rproj` to open it in RStudio.
