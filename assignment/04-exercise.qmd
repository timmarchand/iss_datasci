---
title: "Exercise 04: Sampling and Probability"
date: "2026-05-18"
---
...
::: {.callout-important}
Before starting this exercise, make sure you have worked through [the lesson for this week](/lesson/04-lesson.qmd).
:::
...
1. Download and open the project for this week:
   ...
   - [{{< fa file-archive >}} `04-content.zip`](/files/content/04-content.zip): Download this file, [*unzip it*](/resource/unzipping.qmd), and double-click on `04-content.Rproj` to open it in RStudio.

2. Rename the Quarto file from `04-exercise.qmd` to something that includes your name, e.g. `tanaka-yuki_exercise-04.qmd`, and open it.
