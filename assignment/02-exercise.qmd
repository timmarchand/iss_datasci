---
title: "Exercise 02: R Basics 1: Vectors, Data Frames, Lists"
date: "2026-04-27"
---
...
::: {.callout-important}
Before starting this exercise, make sure you have worked through [the lesson for this week](/lesson/02-lesson.qmd).
:::
...
1. Download and open the project for this week:
   ...
   - [{{< fa file-archive >}} `02-content.zip`](/files/content/02-content.zip): Download this file, [*unzip it*](/resource/unzipping.qmd), and double-click on `02-content.Rproj` to open it in RStudio.

2. Rename the Quarto file from `02-exercise.qmd` to something that includes your name, e.g. `tanaka-yuki_exercise-02.qmd`, and open it.
