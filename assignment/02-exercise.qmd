...
1. Download and open the project for this week:
   ...
   - [{{< fa file-archive >}} `02-exercise.zip`](/projects/02-exercise.zip): Download this file, [*unzip it*](/resource/unzipping.qmd), and double-click on `02-exercise.Rproj` to open it in RStudio.
