...
1. Download and open the project for this week:
   ...
   - [{{< fa file-archive >}} `09-content.zip`](/files/content/09-content.zip): Download this file, [*unzip it*](/resource/unzipping.qmd), and double-click on `09-content.Rproj` to open it in RStudio.
