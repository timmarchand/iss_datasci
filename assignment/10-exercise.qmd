---
title: "Exercise 10: Regression Modelling 1"
date: "2026-06-29"
---
...
::: {.callout-important}
Before starting this exercise, make sure you have worked through [the lesson for this week](/lesson/10-lesson.qmd).
:::
...
1. Download and open the project for this week:
   ...
   - [{{< fa file-archive >}} `10-content.zip`](/files/content/10-content.zip): Download this file, [*unzip it*](/resource/unzipping.qmd), and double-click on `10-content.Rproj` to open it in RStudio.

2. Rename the Quarto file from `10-exercise.qmd` to something that includes your name, e.g. `tanaka-yuki_exercise-10.qmd`, and open it.
