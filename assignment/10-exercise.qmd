...
1. Download and open the project for this week:
   ...
   - [{{< fa file-archive >}} `10-exercise.zip`](/projects/10-exercise.zip): Download this file, [*unzip it*](/resource/unzipping.qmd), and double-click on `10-exercise.Rproj` to open it in RStudio.
