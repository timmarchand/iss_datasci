---
title: "Exercise 13: Data Project Completion and Course Review"
date: "2026-07-13"
---
...
::: {.callout-important}
Before starting this exercise, make sure you have worked through [the lesson for this week](/lesson/13-lesson.qmd).
:::
...
1. Download and open the project for this week:
   ...
   - [{{< fa file-archive >}} `13-exercise.zip`](/projects/13-exercise.zip): Download this file, [*unzip it*](/resource/unzipping.qmd), and double-click on `13-exercise.Rproj` to open it in RStudio.

2. Rename the Quarto file from `13-exercise.qmd` to something that includes your name, e.g. `tanaka-yuki_exercise-13.qmd`, and open it.
