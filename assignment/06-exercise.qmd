...
1. Download and open the project for this week:
   ...
   - [{{< fa file-archive >}} `06-exercise.zip`](/projects/06-exercise.zip): Download this file, [*unzip it*](/resource/unzipping.qmd), and double-click on `06-exercise.Rproj` to open it in RStudio.
