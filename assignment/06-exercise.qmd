---
title: "Exercise 06: Manipulating Data 1"
date: "2026-06-01"
---
...
::: {.callout-important}
Before starting this exercise, make sure you have worked through [the lesson for this week](/lesson/06-lesson.qmd).
:::
...
1. Download and open the project for this week:
   ...
   - [{{< fa file-archive >}} `06-content.zip`](/files/content/06-content.zip): Download this file, [*unzip it*](/resource/unzipping.qmd), and double-click on `06-content.Rproj` to open it in RStudio.

2. Rename the Quarto file from `06-exercise.qmd` to something that includes your name, e.g. `tanaka-yuki_exercise-06.qmd`, and open it.
