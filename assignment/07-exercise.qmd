...
1. Download and open the project for this week:
   ...
   - [{{< fa file-archive >}} `07-exercise.zip`](/projects/07-exercise.zip): Download this file, [*unzip it*](/resource/unzipping.qmd), and double-click on `07-exercise.Rproj` to open it in RStudio.
