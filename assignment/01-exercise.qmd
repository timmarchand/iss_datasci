...
::: {.callout-important}
Before starting this exercise, make sure you have worked through [the lesson for this week](/lesson/01-lesson.qmd).
:::
...
1. Download and open the project for this week:
   ...
   - [{{< fa file-archive >}} `01-exercise.zip`](/projects/01-exercise.zip): Download this file, [*unzip it*](/resource/unzipping.qmd), and double-click on `01-exercise.Rproj` to open it in RStudio.

2. Rename the Quarto file from `01-exercise.qmd` to something that includes your name, e.g. `tanaka-yuki_exercise-01.qmd`, and open it.
