...
1. Download and open the project for this week (this was probably done in class):
   ...
   - [{{< fa file-archive >}} `01-content.zip`](/projects/01-exercise.zip): Download this file, [*unzip it*](/resource/unzipping.qmd), and double-click on `01-content.Rproj` to open it in RStudio.
