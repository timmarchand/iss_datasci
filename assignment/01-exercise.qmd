...
::: {.callout-important}
Before starting this exercise, make sure you have worked through [the content for this week](/content/01-content.qmd).
:::

## Instructions

1. Download and open the project for this week (this was probably done in class):

   - [{{< fa file-archive >}} `01-content.zip`](/files/content/01-content.zip): Download this file, [*unzip it*](/resource/unzipping.qmd), and double-click on `01-content.Rproj` to open it in RStudio.

2. Rename the Quarto file from `01-weekly-notes.qmd` to something that includes your name, e.g. `tanaka-yuki_01-weekly-notes.qmd`, and open it.
...
5. Upload the rendered **HTML file** to [Moodle](https://moodle.univ.gakushuin.ac.jp/mod/forum/view.php?id=11273) by the deadline.
