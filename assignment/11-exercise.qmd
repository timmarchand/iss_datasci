---
title: "Exercise 11: Regression Modelling 2"
date: "2026-07-06"
---
...
::: {.callout-important}
Before starting this exercise, make sure you have worked through [the lesson for this week](/lesson/11-lesson.qmd).
:::
...
1. Download and open the project for this week:
   ...
   - [{{< fa file-archive >}} `11-content.zip`](/files/content/11-content.zip): Download this file, [*unzip it*](/resource/unzipping.qmd), and double-click on `11-content.Rproj` to open it in RStudio.

2. Rename the Quarto file from `11-exercise.qmd` to something that includes your name, e.g. `tanaka-yuki_exercise-11.qmd`, and open it.
