...
1. Download and open the project for this week:
   ...
   - [{{< fa file-archive >}} `11-exercise.zip`](/projects/11-exercise.zip): Download this file, [*unzip it*](/resource/unzipping.qmd), and double-click on `11-exercise.Rproj` to open it in RStudio.
