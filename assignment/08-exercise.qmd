---
title: "Exercise 08: Variable Associations 1"
date: "2026-06-15"
---
...
::: {.callout-important}
Before starting this exercise, make sure you have worked through [the lesson for this week](/lesson/08-lesson.qmd).
:::
...
1. Download and open the project for this week:
   ...
   - [{{< fa file-archive >}} `08-content.zip`](/files/content/08-content.zip): Download this file, [*unzip it*](/resource/unzipping.qmd), and double-click on `08-content.Rproj` to open it in RStudio.

2. Rename the Quarto file from `08-exercise.qmd` to something that includes your name, e.g. `tanaka-yuki_exercise-08.qmd`, and open it.
