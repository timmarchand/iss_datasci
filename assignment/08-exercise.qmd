...
1. Download and open the project for this week:
   ...
   - [{{< fa file-archive >}} `08-exercise.zip`](/projects/08-exercise.zip): Download this file, [*unzip it*](/resource/unzipping.qmd), and double-click on `08-exercise.Rproj` to open it in RStudio.
